...
import { LoansCustomerPage } from '@/pages/customer/LoansPage'
import { FDCustomerPage } from '@/pages/customer/FDPage'
import { ProfilePage } from '@/pages/customer/ProfilePage'
import { SecurityCustomerPage } from '@/pages/customer/SecurityPage'
