          ...
          <CardContent>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              <div>
                ...
                <p className="font-mono text-lg text-navy-900 font-bold">{primaryAccount.account_number}</p>
              </div>
              <div>
          ...
          <CardContent>
            <div className="space-y-4">
              {accounts.filter(a => !a.is_primary).map((account) => (
                <Link key={account.id} to={`/customer/accounts/${account.id}`} className="flex items-center justify-between p-4 rounded-lg border border-navy-100 hover:bg-navy-50 transition-colors">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-navy-500 font-mono">{account.account_number}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4">
